...
Snapshot of records from `data/stage1_raw/` that have not been classified. All notes have `type=""` (empty string). Unlike `partially_classified/` records, no note in these records has a type assigned.
...
- **Source**: Records drawn from `data/stage1_raw/` (11,770 total records)
- **Classified**: 3,921 records moved to `data/stage2_classify/`
