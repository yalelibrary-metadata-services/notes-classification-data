...
Records with at least one empty type value are isolated in `classified/empty_types/`:
...
<records path="classified/by_format/XML/daniel_classified.xml">
  <record bib="17516867">
...
```xml
<?xml version='1.0' encoding='utf-8'?>
<records path="classified/empty_types/martin_with_empty_types.xml">
  <record bib="14526311">
...
- `part_2/p2t2_stats_20251114_084732.md` - Initial statistics and type distribution
- `part_3/p3t3.1_type_presence_20251114_085004.md` - Type attribute presence verification
- `part_3/p3t3.2_empty_types_20251114_085047.md` - Empty type values analysis
- `part_4/p4t4.1_split_20251114_085819.md` - Binary split files report
- `part_4/p4t4.2_final_reorg_20251114_091800.md` - Final reorganization and verification